...
\begin{center}
    ...
    \faEnvelope\ \href{mailto:lindongding@gmail.com}{lindongding@gmail.com}\\[2pt]
    ...
    \ \textbullet\
    \textbf{Senior Research Engineer @ Huawei HKRC}
    }
\end{center}

\Section{SUMMARY}
Senior Research Engineer at Huawei Hong Kong Research Center (HKRC). Ph.D.\ from the Department of Computing, The Hong Kong Polytechnic University (2026). Research focuses on \textbf{LLM reasoning, dialogue systems, multimodal LLMs, and situated conversational recommendation}. Experienced in the full R\&D lifecycle from task formulation and data construction to model design and experimental evaluation, with strong capability in engineering deployment and iterative optimization. Publications appear in ACL, ACM MM, AAAI, TOIS, and TNNLS.

\Section{EDUCATION}
\Entry{The Hong Kong Polytechnic University}{Sept.\ 2022 -- Jul.\ 2026}{Ph.D., Department of Computing (NLP Group)}{Hong Kong, China}
...
\Section{EXPERIENCE}
\Entry{Huawei Hong Kong Research Center (HKRC), Fermat Lab}{Aug 2026 -- Present}{\textbf{Senior Research Engineer}}{Hong Kong SAR, China}
\begin{itemize}
    \item \textbf{Large language model R\&D:} Working on research and development of large language models and their real-world applications.
\end{itemize}

\Entry{Huawei Hong Kong Research Center (HKRC), Fermat Lab}{Aug 2025 -- Jun 2026}{Research Intern (\textbf{Outstanding Intern})}{Hong Kong SAR, China}
\begin{itemize}
...
\Entry{NLP Group, The Hong Kong Polytechnic University}{Dec 2022 -- Jul 2026}{Ph.D. Research, Supervisor: Prof. Wenjie Li}{Hong Kong SAR, China}
\begin{itemize}
...
\begin{itemize}
    \item \textbf{Dongding Lin}, Jian Wang, Yongqi Li, Wenjie Li. Where and What: Reasoning Dynamic and Implicit Preferences in Situated Conversational Recommendation. \textit{ACL 2026} (CCF-A).
    ...
    \item Jian Wang, Yi Cheng, \textbf{Dongding Lin}, et al. Target-oriented proactive dialogue systems with personalization. \textit{EMNLP 2023} (CCF-B).
