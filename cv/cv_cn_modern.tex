...
\ \textbullet\
\textbf{华为香港研究所（HKRC）高级研究工程师}
}
\end{center}

\Section{个人概述}
华为香港研究所（HKRC）费马实验室高级研究工程师，香港理工大学电子计算学系博士（2026 年 7 月毕业）。研究聚焦 \textbf{LLM 推理、对话系统、多模态大模型与情境会话推荐}。
熟悉从任务定义、数据构建、模型设计到实验评测的完整研发流程，并具备工程落地与迭代优化能力，相关工作发表于 ACL、ACM MM、AAAI、TOIS、TNNLS 等。

\Section{教育背景}
\EduOneLine{香港理工大学}{2022.09 -- 2026.07}{电子计算学系博士，GPA 4.18/4.3}{香港，中国}
...
\Section{工作与研究经历}
\Entry{华为香港研究所（HKRC）费马实验室}{2026.08 -- 至今}{\textbf{高级研究工程师（Senior Research Engineer）}}{香港}
\begin{itemize}
    \item \textbf{大模型研发：}从事大语言模型相关的研究与开发及其应用落地。
\end{itemize}

\Entry{华为香港研究所（HKRC）费马实验室}{2025.08 -- 2026.06}{Research Intern，\textbf{优秀实习生}}{香港}
\begin{itemize}
    \item \textbf{无线在线训练数据筛减（基站资源优化）:}
    面向在线训练场景，设计本地数据筛选与分布外（OOD）过滤策略；结合蒸馏式判别与 GPU-KMeans 聚类，在基本不损性能的前提下将训练算力 \textbf{降低 4x}，性能衰减控制在 \textbf{$\le$3\%}，并提交技术报告和相应的代码实现，形成可复用配置与日志闭环，支持快速回滚与复现实验。
...
\Entry{香港理工大学 NLP Group}{2022.12 -- 2026.07}{PhD Research， Supervisor: Prof. Wenjie Li}{香港}
\begin{itemize}
...
\Entry{香港理工大学 NLP Group}{2021.07 -- 2022.12}{Research Assistant, Supervisor: Prof. Wenjie Li}{香港}
\begin{itemize}
...
\Entry{中山大学CIS实验室}{2018.02 -- 2020.07}{Research Assistant, Supervisor: 潘嵘教授 \& 杨敏教授}{广州}
\begin{itemize}
...
\begin{itemize}
    ...
    \item Jian Wang, Chak Tou Leong, Jiashuo Wang, \textbf{Dongding Lin}, Wenjie Li, Xiao-Yong Wei. Instruct once, chat consistently in multiple rounds. \textit{ACL 2024} (CCF-A).
...
\begin{itemize}
    ...
    \item 中山大学优秀毕业生（\textbf{前 3\%}）、优秀毕业论文（\textbf{前 3\%}）
