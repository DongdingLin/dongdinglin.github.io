...
\Section{个人概述}
华为香港研究所（HKRC）高级研究工程师，香港理工大学电子计算学系博士（2026 年毕业）。研究聚焦 \textbf{LLM 推理、对话系统、多模态大模型与情境会话推荐}。
熟悉从任务定义、数据构建、模型设计到实验评测的完整研发流程，并具备工程落地与迭代优化能力，相关工作发表于 ACL、ACM MM、AAAI、TOIS、TNNLS 等。

\Section{教育背景}
\EduOneLine{香港理工大学}{2022.09 -- 2026}{电子计算学系博士，GPA 4.18/4.3}{香港，中国}
...
\Section{工作与研究经历}
\Entry{华为香港研究所（HKRC）}{2026 -- 至今}{\textbf{高级研究工程师（Senior Research Engineer）}}{香港}
\begin{itemize}
    \item \textbf{大模型研发：}从事大语言模型相关的研究与开发及其应用落地。
\end{itemize}

\Entry{华为香港研究所（HKRC）Fermat Lab}{2025.08 -- 2026}{Research Intern，\textbf{优秀实习生}}{香港}
\begin{itemize}
...
\Entry{香港理工大学 NLP Group}{2022.12 -- 2026}{PhD Research， Supervisor: Prof. Wenjie Li}{香港}
\begin{itemize}
